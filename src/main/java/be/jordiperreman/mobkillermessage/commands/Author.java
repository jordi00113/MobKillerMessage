...
public class Author extends MobKillerMessageCmd implements ISubCommand {


    public Author(MobKillerMessage plugin) {
        super(plugin);
    }
    ...
    public boolean doCommand(CommandSender sender, Command command, String[] args) {
        ...
        sender.sendMessage(ChatUtil.color(fc.getString("general.messages.prefix") + "&fThis plugin is developed by &c&ljordi00113&8."));
        return true;
    }

    @Override
    public String getPermission() {
        return "mobkillermessage.author";
    }
